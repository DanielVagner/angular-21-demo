    ...
    <div class="demo-page">
      <div class="page-header">
        ...
        <p>
          ...
          Na rozdíl od <code>computed()</code> (read-only) lze hodnotu i ručně přepsat — ale
          automaticky se resetuje když se zdrojový signal změní.
        </p>
      </div>

      <div class="info-box">
        <strong>Problém s computed() —</strong> computed() je read-only. Nemůžeš napsat
        <code>doubled.set(10)</code>. To je správně pro čisté derivace, ale co třeba "výchozí
        hodnota závisí na vstupu, ale uživatel ji může přepsat"? Pro to přesně je
      ...
      <div class="comparison">
        <div class="comp-col">
          ...
          <pre
            class="code-block"
            style="margin:0"
          >doubled = <span style="color:#d2a8ff">computed</span>(() => count() * 2);
// doubled.set(10); ← CHYBA! Read-only</pre>
        ...
        <div class="comp-col">
          ...
          <pre
            class="code-block"
            style="margin:0"
          >doubled = <span style="color:#d2a8ff">linkedSignal</span>(() => count() * 2);
          ...
          <div class="demo-col">
            ...
            <div class="val-row">
              ...
              <div class="btn-row" style="margin:0">
                ...
                <button class="btn btn-ghost" (click)="linkedDouble.set(999)">
                  Nastavit na 999
                </button>
              </div>
            </div>
...
this.base.set(10);  // linkedDouble() === 20 (znovu odvozeno)</pre>
      ...
      <div class="info-box">
        Výchozí sleva závisí na vybraném produktu, ale uživatel ji může ručně upravit. Při přepnutí
        produktu se sleva resetuje na výchozí pro daný produkt.
      </div>
      <div class="live-demo">
        ...
        <div class="discount-row">
          ...
          <div class="discount-controls">
            ...
            <button class="btn btn-ghost" (click)="decreaseDiscount()">−5%</button>
            <button class="btn btn-ghost" (click)="increaseDiscount()">+5%</button>
            <button class="btn btn-secondary" (click)="resetDiscount()">Reset výchozí</button>
          </div>
          <div class="hint">
            Výchozí sleva produktu: <strong>{{ defaultDiscount() }}%</strong> — přepnutím produktu
            se sleva resetuje
          </div>
        </div>
      ...
      <pre
        class="code-block"
      >selectedProduct = <span style="color:#d2a8ff">signal</span>(products[0]);
...
export class LinkedSignalDemoComponent {
 ...
 defaultDiscount = computed<number>(() => {
  ...
  this.discount.update(v => Math.max(0, v - 5));
}

increaseDiscount(): void {
  this.discount.update(v => Math.min(50, v + 5));
}
